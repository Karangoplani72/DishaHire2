          ...
          {success ? (
            ...
            >
              <div className="text-center mb-10">
                ...
                <p className="text-gray-400 text-sm mt-2">Professional Identity Hub</p>
              </div>
              ...
              <div className="mt-8 pt-6 border-t border-gray-100 text-center">
                <button onClick={() => navigate('/')} className="text-[10px] font-black uppercase tracking-widest text-gray-400 hover:text-brand-gold transition-colors">Return to Homepage</button>
              </div>
            </motion.div>
          )}
        </AnimatePresence>
