          ...
          <div className="space-y-8">
            ...
            <div className="flex space-x-4">
              <a 
                ...
                className="w-12 h-12 rounded-full bg-white/5 border border-white/10 flex items-center justify-center hover:bg-brand-gold hover:text-brand-dark hover:scale-110 transition-all duration-300 group"
                aria-label="LinkedIn"
              >
                <Linkedin size={20} className="group-hover:stroke-[2.5px]" />
              </a>
              <a 
              ...
              >
                <Instagram size={20} className="group-hover:stroke-[2.5px]" />
              </a>
              <a 
            ...
            <ul className="space-y-5">
              {NAV_LINKS.map(link => (
                <li key={link.name}>
                  <Link 
                    to={link.href} 
                    className="text-gray-400 hover:text-brand-gold text-sm font-medium flex items-center group transition-colors"
                  >
                    <ArrowRight size={14} className="mr-3 opacity-0 group-hover:opacity-100 -translate-x-2 group-hover:translate-x-0 transition-all" />
                    {link.name}
                  </Link>
                </li>
              ))}
